# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 23:02:00 2019
...
# Evaluate the model and print results
  eval_input_fn = tf.estimator.inputs.numpy_input_fn(
      ...
      num_epochs=1,
      shuffle=False)
  labels = np.array(["T-shirt/top", "Trouser", "Pullover", "Dress",
                          "Coat", "Sandal", "Shirt", "Sneaker", "Bag", "Ankle boot"])
  eval_results = mnist_classifier.evaluate(input_fn=eval_input_fn)
  print(tf.sess.run(tf.argmax(eval_data, 1), feed_dict={labels:eval_labels}))
  print(eval_results)
