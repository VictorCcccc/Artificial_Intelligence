...
def load_dataset(data_dir=''):
    ...
    """
    x_train = np.load("C:\\Users\\Victor\\Desktop\\ECE448\\mp3-code\\mp3-code\\part1\\data\\x_train.npy")
    y_train = np.load("C:\\Users\\Victor\\Desktop\\ECE448\\mp3-code\\mp3-code\\part1\\data\\y_train.npy")
    x_test = np.load("C:\\Users\\Victor\\Desktop\\ECE448\\mp3-code\\mp3-code\\part1\\data\\x_test.npy")
    y_test = np.load("C:\\Users\\Victor\\Desktop\\ECE448\\mp3-code\\mp3-code\\part1\\data\\y_test.npy")
...
if __name__ == '__main__':
    ...
    fig, ax = plt.subplots(2, 5, figsize=(12, 5))
    for i in range(10):
        index = class_image[i][1]
        ax[i % 2, i // 2].imshow(x_test[index].reshape((28, 28)))
        ax[i % 2, i // 2].set_xticks([])
        ax[i % 2, i // 2].set_yticks([])
        ax[i % 2, i // 2].set_title(class_names[i])
    plt.show()
    '''
